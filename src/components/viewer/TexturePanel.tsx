            ...
            <div key={key} className="flex items-center gap-2.5">
              ...
              <div className="flex gap-1.5 overflow-x-auto scrollbar-none">
                ...
                <button
                  ...
                  className={`flex h-8 shrink-0 items-center justify-center rounded-md border px-2.5 text-xs font-medium transition-colors ${
                    !selected
                ...
                {categoryPresets.map((preset) => (
                  <button
                    ...
                    className={`h-8 w-8 shrink-0 overflow-hidden rounded-md border transition-all ${
                      selected === preset.id
